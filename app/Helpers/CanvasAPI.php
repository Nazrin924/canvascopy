...
class CanvasAPI {
    ...
    */
    ...
    public static function createCourse($courseId,$courseName,$netid) {
        $params="accounts/51/courses?course[name]=".$courseName."&course[code]=".$courseId."&course[sis_course_id]=".$courseId."&course[integration_id]=".$courseId."-canvastools&course[term_id]=46"."&course[is_public]=false&blueprint_course_id=user-created-course-blueprint";
