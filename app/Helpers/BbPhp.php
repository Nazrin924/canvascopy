...
END;
    ...
    private function buildRequest($method, $service, $args = null)
    {
    ...
    public function __call($method, $args)
    {
        ...
        if (in_array($method, $this->services)) {
            if (isset($args[2])) {
                return $this->doCall($args[0], $method, $args[1], $args[2]);
            }
    ...
    public function doCall($method = null, $service = 'Context', $args = null, $netID = '')
    {
        ...
        if ($this->use_curl) {
            ...
            curl_setopt($ch, CURLOPT_HTTPHEADER,
                ['Content-type: text/xml; charset=utf-8', 'SOAPAction: "'.$method.'"']);
