		...
		<section class="band" id="main-content">
			...
			<div class="container">
				...
				<main id="main" tabindex="-1" class="aria-target border-box">
					<article>
						<h2 class="text-center">Sorry we couldn't process your request at this time.</h2>

						<p>This course already exists in Canvas@Cornell.</p>

						<p>Please return to request options to modify your course information.</p>

						<form class="form-basic" action="{{URL::route('badIDRedirect')}}" method="GET">
